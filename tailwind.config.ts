  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        "accent-beige": "hsl(42 35% 74%)",
        "accent-beige-muted": "hsl(42 35% 74% / 0.28)",
      ...
      keyframes: {
        ...
        "price-flash": { "0%, 100%": { backgroundColor: "transparent" }, "50%": { backgroundColor: "hsl(42 35% 74% / 0.12)" } },
      },
      animation: {
        "accordion-down": "accordion-down 0.2s ease-out",
        "accordion-up": "accordion-up 0.2s ease-out",
        "price-flash": "price-flash 0.25s ease-out",
      },
    },
  },
